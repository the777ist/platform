...
#
# Everything above tests the resources the demo happens to ship. The failure worth
# preventing is the NEXT one: a product adds an owner-scoped model, wires it through a
# service, and nobody writes the isolation test — which is exactly how the demo
