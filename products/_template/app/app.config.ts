...
const config: ExpoConfig = {
  ...
  ios: { bundleIdentifier: "com.the777incident.template" },
  android: {
    package: "com.the777incident.template",
    adaptiveIcon: {
  ...
  plugins: [
    ...
    [
      ...
      "@sentry/react-native/expo",
      {
        ...
        project: "the777incident-template", // Sentry project slug (created on infra day)
      },
    ],
  ],
