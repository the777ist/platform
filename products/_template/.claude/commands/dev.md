...
Or individually: `pnpm --filter @sevenfold/template-api dev` (uvicorn --reload; port =
8000 + 10·portIndex from product.json) and `pnpm --filter @sevenfold/template-app dev`
