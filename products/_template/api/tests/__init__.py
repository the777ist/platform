"""Test package init — runs BEFORE conftest imports template_api.main.

`template_api.main` builds the app at module level (uvicorn entrypoint), which reads
Settings at import time — so the required DB URLs must exist in the environment before
any template_api import happens.
"""
...
TEST_DB_NAME = "template_api" + "_test"
