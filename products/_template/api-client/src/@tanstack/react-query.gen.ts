...
import { createItem, deleteItem, getItem, healthz, hello, listItems, me, type Options, registerToken, updateItem } from '../sdk.gen';
import type { CreateItemData, CreateItemError, CreateItemResponse, DeleteItemData, DeleteItemError, DeleteItemResponse, GetItemData, GetItemError, GetItemResponse, HealthzData, HealthzResponse, HelloData, HelloResponse, ListItemsData, ListItemsError, ListItemsResponse, MeData, MeResponse, RegisterTokenData, RegisterTokenError, RegisterTokenResponse, UpdateItemData, UpdateItemError, UpdateItemResponse } from '../types.gen';
...
export const listItemsInfiniteOptions = (options?: Options<ListItemsData>) => {
    const opts = infiniteQueryOptions<ListItemsResponse, ListItemsError, InfiniteData<ListItemsResponse>, QueryKey<Options<ListItemsData>>, string | null | Pick<QueryKey<Options<ListItemsData>>[0], 'body' | 'headers' | 'path' | 'query'>>(
    // @ts-ignore
    {
 ...
 * Register Token
 */
export const registerTokenMutation = (options?: Partial<Options<RegisterTokenData>>): UseMutationOptions<RegisterTokenResponse, RegisterTokenError, Options<RegisterTokenData>> => {
    const mutationOptions: UseMutationOptions<RegisterTokenResponse, RegisterTokenError, Options<RegisterTokenData>> = {
        mutationFn: async (fnOptions) => {
