...
- **Save path is fixed**: `products/<product>/docs/architecture/<TICKET-ID>-<slug>_architecture.md`. `<TICKET-ID>` and `<slug>` are exactly what the resolve block produced — do NOT re-derive either here.
