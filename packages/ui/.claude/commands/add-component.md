Add a Tier-1 owned primitive to @sevenfold/ui. Argument: $ARGUMENTS (component name).

1. cli-add (or author): `pnpm --filter @sevenfold/ui dlx @react-native-reusables/cli add <name>`
